...
namespace Guardian_BugTracker_23.Data
{
    public static class DataUtility
    {
        ...
        public static async Task SeedDefaultTicketsAsync(ApplicationDbContext context, UserManager<BTUser> userManager)
        {
            ...
            int typeBugFix = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.BugFix))!.Id;
            int typeDiscovery = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.Discovery))!.Id;
            int typeResearch = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.Research))!.Id;
