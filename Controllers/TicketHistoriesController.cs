...
namespace Guardian_BugTracker_23.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.History.Include(t => t.Ticket).Include(t => t.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ticketHistory = await _context.History
                .Include(t => t.Ticket)
                .Include(t => t.User)
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,PropertyName,Description,Created,OldValue,NewValue,UserId")] TicketHistory ticketHistory)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.BTUsers, "Id", "Id", ticketHistory.UserId);
            return View(ticketHistory);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ticketHistory = await _context.History.FindAsync(id);
            if (ticketHistory == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (ticketHistory != null)
            {
                _context.History.Remove(ticketHistory);
            }
